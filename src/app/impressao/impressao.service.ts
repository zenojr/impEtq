...
export class ImpressaoService {
  ...
  getDataTest() { return this.http.get( this.urlBase + this.param,
                                        { responseType: 'text' }); }

  getImpressao( fatorConv, codBobina, reInspec,
                produto, tipoProd, opcao ) { return  this.http.get( this.urlBase + '?fatorConv=' + fatorConv + '&codBobina=' + codBobina +
                                                                    '&reInspec=' + reInspec + '&produto=' + produto +
